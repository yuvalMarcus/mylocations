...
const Marker = ({
    ...
    <div>
        <div
            ...
            title={title}
        />
        <div className={'rounded-full h-4 w-4 absolute left-1/2 top-1/2 -mt-3 -ml-2 rotate-x-55 z-0 after:empty-content after:rounded-full after:h-10 after:w-10 after:absolute after:-mt-3 after:-ml-3.5 after:opacity-0 after:shadow-marker after:animate-pulsate-out'} />
    </div>
);
